...
feature "as a logged in user" do
  ...
  scenario "I can't modify other user data" do
    user1   = create(:user)
    user2  = create(:user)
  ...
  scenario "I can modify my data but only with valid attributes" do
    user   = create(:user)
    ...
    fill_in "user[username]", with: "Frank"
    fill_in "user[name]", with: "Frankie"
    fill_in "user[password]", with: "Hamburger"
